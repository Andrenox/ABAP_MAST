CLASS zcl_fabap_jul2025_EXER_04_MAST DEFINITION
                                     PUBLIC
                                     FINAL
                                     CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES gty_conn TYPE STANDARD TABLE OF zi_fabap_demo01_eat
                   WITH EMPTY KEY.
...
CLASS ZCL_FABAP_JUL2025_EXER_04_MAST IMPLEMENTATION.
  ...
  METHOD get_data BY DATABASE PROCEDURE
   ...
   USING zi_fabap_demo01_eat.
     ...
     et_data = select Connection.carrierid     as CarrierId,
                     ...
                     case
                        when  Connection.airportfromid = 'SFO'
                            then '080000'
